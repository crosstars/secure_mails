...
"")
        ...
        self.uname.setGeometry(QtCore.QRect(150, 220, 491, 31))
        ...
        self.passwd.setGeometry(QtCore.QRect(150, 390, 491, 31))
...
"selection-background-color: rgb(26, 95, 180);")
        ...
        self.passwd_retype.setGeometry(QtCore.QRect(150, 300, 491, 31))
    ...
    def enable_btn(self): 
        self.signup_btn.setEnabled(self.passwd_retype.text() != "" and self.passwd.text() != "" and self.uname.text() != "")
