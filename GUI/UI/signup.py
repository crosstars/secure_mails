...
class Ui_signup_window(object):
    def setupUi(self, signup_window):
        ...
        self.missmatch.setStyleSheet("color: rgb(224, 27, 36);")
...
"selection-background-color: rgb(26, 95, 180);")
        ...
        self.label_4.setGeometry(QtCore.QRect(150, 190, 81, 32))
    ...
    def retranslateUi(self, signup_window):
        ...
        self.uname_2.setWhatsThis(_translate("signup_window", "<html><head/><body><p>Username</p></body></html>"))
